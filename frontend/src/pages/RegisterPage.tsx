...
import { UserPlus, Mail, Lock, Loader2, ArrowLeft, Chrome } from 'lucide-react';
  ...
  return (
    <Page>
      <Card>
        ...
        <Subtitle>注册后即可同步你的听写进度和上传的句子。</Subtitle>

        <Form onSubmit={handleSubmit}>
          <Field>
            <LabelRow>
              <Label>昵称（可选）</Label>
              <Hint>用于显示在导航栏和主页中</Hint>
            </LabelRow>
            <InputWrapper>
              <InputIcon>
                <UserPlus size={16} />
